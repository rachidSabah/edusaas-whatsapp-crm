// Hybrid Authentication utilities for Cloudflare D1 + Turso
// This module provides authentication functions that work with both:
// - Cloudflare D1 (when available in Cloudflare Pages)
// - Turso HTTP (as fallback)

import { SignJWT, jwtVerify } from 'jose';
import { cookies } from 'next/headers';
import { getDbContext, getOne, query, execute } from './db-hybrid';
